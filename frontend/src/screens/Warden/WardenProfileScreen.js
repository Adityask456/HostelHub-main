  ...
  return (
    <SafeAreaView style={styles.root}>
      <ScrollView contentContainerStyle={{ paddingBottom: 40 }}>
        {/* Hero Section */}
        <View style={[styles.hero, { backgroundColor: me?.role === 'ADMIN' ? '#cfe8ff' : heroBgBase }]}> 
          <View style={styles.heroContent}>
            ...
            <Text style={styles.name}>{me?.name || (me?.role === 'ADMIN' ? 'Admin' : 'Warden')}</Text>
            <Text style={styles.roleBadge}>{(me?.role || 'WARDEN').toUpperCase()}</Text>
