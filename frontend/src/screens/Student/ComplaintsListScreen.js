    ...
    <View style={styles.card}>
      ...
      {item.user && (
        <View style={styles.userInfo}>
          <Text style={styles.userName}><Text style={styles.bold}>Student:</Text> {item.user.name}</Text>
          {item.user.roomnumber && <Text style={styles.roomNumber}><Text style={styles.bold}>Room:</Text> {item.user.roomnumber}</Text>}
        </View>
      )}
